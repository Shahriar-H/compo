...
import {View, StyleSheet,Image,TouchableOpacity,Text,TextInput,   ActivityIndicator,Alert, NativeSyntheticEvent} from 'react-native';
...
const Forgotpassword = ({state, dispatch}) => {
        ...
        <View style={styles.mainContainer}>
            <View style={styles.loginPart}>
                <View>
                    ...
                    <TextInput value={opthere} onChangeText={(v)=>setopthere(v)} keyboardType="number-pad" style={styles.loginInput} placeholder={"456857"} placeholderTextColor={'black'} />
                    ...
                    <View style={styles.resednCode}>
                        <TouchableOpacity delayPressIn={0} delayPressOut={0} onPress={Forgotphone}>
