...
const One2tweleve = () => { 
    ...
    return (
        <ScrollView style={styles.mainContainer}>
            ...
            <CategoryItem info={{name:"1-12 Class",path:"Paidcourse",returnPath:"One2tweleveCat",status:"free"}}/> 
            <CategoryItemPaid info={{name:"Paid 1-12 Course",path:"Paidcourse",returnPath:"One2tweleveCat"}}/>
            <CategoryItemLive info={{name:"Live Course",path:"Paidcourse",returnPath:"One2tweleveCat"}}/>
